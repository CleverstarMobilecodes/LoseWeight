...
public class ProgressWheel extends View {
	...
	public ProgressWheel(Context context, AttributeSet attrs) {
		...
		paddingLeft = paddingTop = paddingRight = paddingBottom = (int) Constants.pxFromDp(context, 8);
		...
		if (tablet) {
			paddingLeft = paddingTop = paddingRight = paddingBottom =  (int) Constants.pxFromDp(context, 4);;
		}
	...
	private void setupBounds() {
		...
		*/
		circleBounds = new RectF(paddingLeft + 20,
				paddingTop + 20,
                this.getLayoutParams().width - paddingRight - 20,
                this.getLayoutParams().height - paddingBottom - 20);
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawArc(rectBounds, -90, 360, true, rimPaint);
		...
		if(isSpinning) {
			...
			if (progress != 0) {
				canvas.drawArc(rectBounds, -90, progress, true, barPaint);
			}
		}
